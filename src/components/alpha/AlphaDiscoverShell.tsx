...
/**
 * Shared chrome for the two Alpha discovery artboards — category filter and
 * search, then the Top Groups header. Only the header tone and the result
 * layout differ between them.
 */
export function AlphaDiscoverShell({
  tone = "light",
  children,
}: {
  tone?: "brand" | "light";
  ...
  return (
    <AppShell className="bg-surface-alt">
      <AlphaTopBar variant="back" tone={tone} backHref="/alpha/chats" />
